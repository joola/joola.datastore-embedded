              ...
              if (key !== '_id') {
                ...
                switch (operator) {
                  ...
                  case '$avg':
                    ...
                    break;
                  case '$min':
                    result[key] = result[key] || curr[attribute];
                    if (result[key] > curr[attribute])
                      result[key] = curr[attribute];
                    break;
                  case '$max':
                    result[key] = result[key] || curr[attribute];
                  ...
                  case '$ucount':
                    ...
                    if (result['__bag_' + key].indexOf(curr[attribute]) === -1)
                      result['__bag_' + key].push(curr[attribute])
                    break;
                  default:
                    break;
                }
          ...
          finalize: function (result) {
            ...
            Object.keys(_query.query[1].$group).forEach(function (key) {
              if (key !== '_id') {
                ...
                switch (operator) {
                  case '$avg':
                    result[key] = result[attribute] / result['__count_' + key];
                    break;
                  case '$ucount':
